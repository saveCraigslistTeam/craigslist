...
class Sale extends Model {
  ...
  factory Sale(
    ...
    return Sale._internal(
        ...
        zipcode: zipcode,
        price: price,
        SaleImages: SaleImages != null
            ? List<SaleImage>.unmodifiable(SaleImages)
            : SaleImages);
  }
  ...
  Map<String, dynamic> toJson() => {
        ...
        'zipcode': _zipcode,
        'price': _price,
        'SaleImages': _SaleImages?.map((SaleImage? e) => e?.toJson()).toList(),
