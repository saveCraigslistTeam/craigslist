...
class Conversation {
  ...
  final Message message2 = Message(
      userId: "user1", receiverId: "hank123", messageText: "Hi, yes it is");
  ...
  final Message message5 = Message(
      ...
      receiverId: "user1",
      messageText:
          "But, my kid has cancer! You don't understand how much this Playstation 5 will mean to him!");
  ...
  final Message message8 =
      Message(userId: "user1", receiverId: "hank123", messageText: "What?");

  final Message message9 =
      Message(userId: "hank123", receiverId: "user1", messageText: "afdsasdf?");

  final Message message10 =
      Message(userId: "user1", receiverId: "hank123", messageText: "What?");
